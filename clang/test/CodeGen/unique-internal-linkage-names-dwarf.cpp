...
// PLAIN-DAG: !DISubprogram(name: "foo", linkageName: "_ZL3foov"{{.*}})
...
// PLAIN-DAG: !DISubprogram(name: "bar", linkageName: "_ZN12_GLOBAL__N_13barEv"{{.*}})
...
// PLAIN-DAG: !DISubprogram(name: "zip", linkageName: "_ZL3zipv"{{.*}})
...
// UNIQUE-DAG: !DISubprogram(name: "foo", linkageName: "_ZL3foov.[[MODHASH]]"{{.*}})
...
// UNIQUE-DAG: !DISubprogram(name: "bar", linkageName: "_ZN12_GLOBAL__N_13barEv.[[MODHASH]]"{{.*}})
...
// UNIQUE-DAG: !DISubprogram(name: "zip", linkageName: "_ZL3zipv.[[MODHASH]]"{{.*}})
