...
// CHECK-DAG: ![[destructor]] = !DISubprogram(name: "~A", {{.*}}, type: ![[subroutinetype:[0-9]+]]
...
// MSVC-DAG: ![[destructor:[0-9]+]] = !DISubprogram(name: "~A", linkageName: "??_GA@@UEAAPEAXI@Z", {{.*}}, type: ![[subroutinetype:[0-9]+]]
