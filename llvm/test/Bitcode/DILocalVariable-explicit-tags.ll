...
; CHECK: ![[SP:[0-9]+]] = !DISubprogram(name: "foo",{{.*}} retainedNodes: ![[VARS:[0-9]+]]
...
!0 = !DISubprogram(name: "foo", scope: null, isLocal: false, isDefinition: true, isOptimized: false, retainedNodes: !1)
!1 = !{!2, !3}
