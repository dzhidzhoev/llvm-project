...
!4 = !DISubprogram(name: "test", scope: !1, file: !1, line: 12, type: !5, isLocal: false, isDefinition: true, scopeLine: 13, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !8)
...
;ALL: [[SCOPE:![0-9]+]] = !DISubprogram(name: "test",{{.*}}
