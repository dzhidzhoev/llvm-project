...
; CHECK: !DISubprogram(name: "unroll", {{.*}}keyInstructions: true)
...
!5 = !DISubprogram(name: "unroll", linkageName: "unroll", scope: null, file: !1, line: 1, type: !6, scopeLine: 1, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, keyInstructions: true)
