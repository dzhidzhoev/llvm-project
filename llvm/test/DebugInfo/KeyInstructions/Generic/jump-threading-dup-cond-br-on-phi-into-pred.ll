...
; CHECK: !DISubprogram(name: "test5", {{.*}}keyInstructions: true)
...
!5 = !DISubprogram(name: "test5", linkageName: "test5", scope: null, file: !1, line: 1, type: !6, scopeLine: 1, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, keyInstructions: true)
