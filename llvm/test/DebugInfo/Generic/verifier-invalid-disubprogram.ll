...
!11 = !DISubprogram(retainedNodes: !{!0})

; CHECK: invalid reference flags
define void @invalid_reference_flags_reference() !dbg !12 { ret void }
!12 = !DISubprogram(flags: DIFlagLValueReference | DIFlagRValueReference)

; CHECK: invalid reference flags
define void @invalid_reference_flags_pass_by() !dbg !13 { ret void }
!13 = !DISubprogram(flags: DIFlagTypePassByValue | DIFlagTypePassByReference)
...
!19 = !DISubprogram(isDefinition: false, flags: DIFlagAllCallsDescribed)
