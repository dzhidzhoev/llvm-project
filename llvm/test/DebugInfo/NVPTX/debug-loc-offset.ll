...
; CHECK-NEXT: .b8 99
; CHECK-NEXT: .b8 0
; CHECK-NEXT: .b8 2                                   // Abbrev [2] 0x54:0x34 DW_TAG_subprogram
...
; CHECK-NEXT: .b8 3                                   // Abbrev [3] 0x7a:0xd DW_TAG_formal_parameter
...
; CHECK-NEXT: .b8 4                                   // Abbrev [4] 0x88:0x7 DW_TAG_base_type
...
; CHECK-NEXT: .b8 99
; CHECK-NEXT: .b8 0
; CHECK-NEXT: .b8 5                                   // Abbrev [5] 0x54:0x3a DW_TAG_subprogram
...
; CHECK-NEXT: .b8 1                                   // DW_AT_external
; CHECK-NEXT: .b8 6                                   // Abbrev [6] 0x77:0x9 DW_TAG_formal_parameter
; CHECK-NEXT: .b8 97                                  // DW_AT_name
; CHECK-NEXT: .b8 0
; CHECK-NEXT: .b8 2                                   // DW_AT_decl_file
; CHECK-NEXT: .b8 6                                   // DW_AT_decl_line
; CHECK-NEXT: .b32 142                                // DW_AT_type
; CHECK-NEXT: .b8 7                                   // Abbrev [7] 0x80:0xd DW_TAG_variable
; CHECK-NEXT: .b8 122                                 // DW_AT_name
; CHECK-NEXT: .b8 0
; CHECK-NEXT: .b8 2                                   // DW_AT_decl_file
; CHECK-NEXT: .b8 7                                   // DW_AT_decl_line
; CHECK-NEXT: .b64 .debug_info+136                    // DW_AT_type
; CHECK-NEXT: .b8 0                                   // End Of Children Mark
; CHECK-NEXT: .b8 8                                   // Abbrev [8] 0x8e:0x4 DW_TAG_structure_type
