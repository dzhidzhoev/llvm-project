...
; CHECK-NEXT: .b8 112
; CHECK-NEXT: .b8 0
; CHECK-NEXT: .b8 2                                   // Abbrev [2] 0x55:0x53 DW_TAG_subprogram
...
; CHECK-NEXT: .b8 4                                   // Abbrev [4] 0x85:0x9 DW_TAG_formal_parameter
; CHECK-NEXT: .b8 120                                 // DW_AT_name
; CHECK-NEXT: .b8 0
; CHECK-NEXT: .b8 1                                   // DW_AT_decl_file
; CHECK-NEXT: .b8 6                                   // DW_AT_decl_line
; CHECK-NEXT: .b32 236                                // DW_AT_type
; CHECK-NEXT: .b8 4                                   // Abbrev [4] 0x8e:0x9 DW_TAG_formal_parameter
; CHECK-NEXT: .b8 121                                 // DW_AT_name
; CHECK-NEXT: .b8 0
; CHECK-NEXT: .b8 1                                   // DW_AT_decl_file
; CHECK-NEXT: .b8 6                                   // DW_AT_decl_line
; CHECK-NEXT: .b32 236                                // DW_AT_type
; CHECK-NEXT: .b8 3                                   // Abbrev [3] 0x97:0x10 DW_TAG_formal_parameter
; CHECK-NEXT: .b8 2                                   // DW_AT_address_class
; CHECK-NEXT: .b8 5                                   // DW_AT_location
; CHECK-NEXT: .b8 144
; CHECK-NEXT: .b8 177
...
; CHECK-NEXT: .b8 1                                   // DW_AT_decl_file
; CHECK-NEXT: .b8 6                                   // DW_AT_decl_line
; CHECK-NEXT: .b32 194                                // DW_AT_type
; CHECK-NEXT: .b8 0                                   // End Of Children Mark
; CHECK-NEXT: .b8 5                                   // Abbrev [5] 0xa8:0x1a DW_TAG_variable
...
; CHECK-NEXT: .b8 6                                   // Abbrev [6] 0xc2:0x7 DW_TAG_base_type
; CHECK-NEXT: .b8 105                                 // DW_AT_name
; CHECK-NEXT: .b8 110
; CHECK-NEXT: .b8 116
; CHECK-NEXT: .b8 0
...
; CHECK-NEXT: .b8 5                                   // Abbrev [5] 0xc9:0x1a DW_TAG_variable
...
; CHECK-NEXT: .b8 6                                   // Abbrev [6] 0xe3:0x9 DW_TAG_base_type
