...
; CHECK: !DISubprogram(name: "main", {{.*}}, unit: ![[CU1]]
; CHECK: !DISubprogram(name: "func1", {{.*}}, unit: ![[CU2]]
; CHECK-NOT: !DISubprogram(name: "func2"
; CHECK: !DISubprogram(name: "func3", {{.*}}, unit: ![[CU2]]
; CHECK: !DISubprogram(name: "func4", {{.*}}, unit: ![[CU2]]
...
!2 = !{}
!4 = !DISubprogram(name: "func1", scope: !1, file: !1, line: 1, type: !5, isLocal: false, isDefinition: true, scopeLine: 1, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !8)
...
!11 = !DISubprogram(name: "func2", scope: !1, file: !1, line: 8, type: !5, isLocal: false, isDefinition: true, scopeLine: 8, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !12)
!12 = !{!13}
...
!27 = !DISubprogram(name: "func3", scope: !1, file: !1, line: 8, type: !5, isLocal: false, isDefinition: true, scopeLine: 8, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !28)
!28 = !{!29}
!29 = !DILocalVariable(name: "n", arg: 1, scope: !30, file: !1, line: 8, type: !7)
!30 = !DISubprogram(name: "func4", scope: !1, file: !1, line: 8, type: !5, isLocal: false, isDefinition: true, scopeLine: 8, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !31)
!31 = !{!32}
