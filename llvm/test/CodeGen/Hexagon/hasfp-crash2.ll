...
!31 = !{!"foo2", !".text"}
!32 = !{!"foo3", !".text"}
!33 = !DISubprogram(name: "foo1", scope: !34, file: !34, line: 84, type: !35, isLocal: false, isDefinition: true, scopeLine: 85, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !44)
