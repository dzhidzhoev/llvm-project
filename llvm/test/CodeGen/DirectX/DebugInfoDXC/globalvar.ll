...
;; RUN: llvm-objcopy --dump-section=DXIL=%t.O0.bc %t.O0.dxbc
;; RUN: dxc /dumpbin %t.O0.dxbc | FileCheck %s --check-prefixes=CHECK,CHECK-O0

;; RUN: llc -mtriple=dxil-pc-shadermodel6.3-library --filetype=obj -o %t.default.dxbc %s
;; RUN: llvm-objcopy --dump-section=DXIL=%t.default.bc %t.default.dxbc
;; RUN: dxc /dumpbin %t.default.dxbc | FileCheck %s --check-prefixes=CHECK,CHECK-DEFAULT
